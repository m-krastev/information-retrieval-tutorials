...
parser.add_argument("--limit_dataset", type=float, default=1.0, help="Limit the dataset to X% of the original")
...
if args.limit_dataset < 1.0:
    from torch.utils.data import random_split
    train_dataset, _ = random_split(train_dataset, [args.limit_dataset, 1 - args.limit_dataset])
    print(f"Limiting the dataset to {args.limit_dataset:.0%} of the original. Length of train set: {len(train_dataset)}")
